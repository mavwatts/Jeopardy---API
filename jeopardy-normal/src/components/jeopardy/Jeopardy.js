...
import "/Users/mavrickwatts/kenzieprojects/Q2/jeopardy-lab-normal-mode/jeopardy-normal/src/index.css";
    ...
    return (
      ...
      <div className="cardwrapper">
        <div className="Jeopardy">
          ...
          <div className="score">Your winnings: {this.state.score}</div>
        </div>
      </div>
